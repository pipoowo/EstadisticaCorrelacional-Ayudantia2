...
<h1 style="font-size:60px; font-weight:bold; line-height:1.1; margin-bottom:40px;">
...
::: {style="text-align:center;"}
<img src="preguntonof.png" style="width:65%; display:block; margin:auto;"/>
:::
...
::: {style="text-align:center;"}
<img src="girl.png" style="width:40%; display:block; margin:auto;"/>
:::
...
<img src="bienestar_yoga.png" style="width:60%;"/>
:::
...
::: {style="text-align:center;"}
<img src="wellnessof.png" style="width:65%; display:block; margin:auto;"/>
:::
...
::: {style="text-align:center;"}
<img src="web_scrap.png" style="width:60%; display:block; margin:auto;"/>
:::
...
-   **Distribución temporal de las publicaciones (2017–2024)** <br>
    ...
    ::: {style="text-align:center;"}
    <img src="artaños.png" style="width:60%; display:block; margin:auto;"/>
    :::
...
-   **Cantidad de artículos por grupos mayoritarios** <br>
    ...
    ::: {style="text-align:center;"}
    <img src="artgrupo.png" style="width:60%; display:block; margin:auto;"/>
    ::: 
...
-   **TF-IDF: términos distintivos en wellness y bienestar transversal** <br>
    ...
    ::: {style="text-align:center;"}
    <img src="TFIDF.png" style="width:60%; display:block; margin:auto;"/>
    ::: 
...
-   **Bigramas más frecuentes** <br>
    ...
    ::: {style="text-align:center;"}
    <img src="bifrecuentes.png" style="width:60%; display:block; margin:auto;"/>
    ::: 
...
-   **Keyness: palabras distintivas por grupo** <br>
    ...
    ::: {style="text-align:center;"}
    <img src="keyness.png" style="width:60%; display:block; margin:auto;"/>
    :::
...
-   **Modelo LDA: subtemas del discurso wellness** <br>
    ...
    ::: {style="text-align:center;"}
    <img src="LDA.png" style="width:60%; display:block; margin:auto;"/>
    :::
...
-   **Evolución temporal del léxico bienestar (2017–2024)** <br>
    ...
    ::: {style="text-align:center;"}
    <img src="evolutemporal.png" style="width:60%; display:block; margin:auto;"/>
    :::
