...
La covarianza es una medida de asociación entre variables basada en la variabilidad de cada una de ellas, pero su valor no es interpretable directamente...

A pesar de que mida la relación/asociación lineal entre dos variables, solo indica la dirección (positiva o negativa), la magnitud depende de las unidades de las variables.
...
variables_info <- tibble::tribble(
  ...
  "Dirección", "Determinado por el signo del valor: positiva () o negativa",
  "Intensidad o magnitud", "Criterios de Cohen (1988, 1992): muy pequeño (menor a 0.1), pequeño (entre 0.1 a 0.3), moderado (entre 0.3 y 0.5), grande (mayor a 0.5)",
...
**Importante: refiere a asociación, NO a causalidad ni explicación**
...
Así, obtendremos el valor-t, valor-p, el intervalo de confianza al 95% de confianza y el valor de la correlación.
...
-   Medida estadística que se empleó.

-   Variables utilizadas y su naturaleza.
...
-   Para graficarla, se utlilizan gráficos de nube de puntos.
